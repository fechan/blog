...
If you let "moving one block east" increase the x-coordinate by 1, "moving north" increase the z, and "moving up" increase the y, then you can determine the relative coordinate of blocks after I strafe in a cardinal direction. If I start at {0,0,0} and go east, I just have to increment x by 1 and get {1,0,0}. However, it gets more complicated because the turtle is constantly turning. If I face north, turn left, and go forward, I'm going east. If I turn left and go forward again, I'm going south! I can't just simply increment x by 1 anymore, so I have to take orientation into account when calculating my destination block. Like before, we *could* use the F3 menu's compass, but we can make it easy on ourselves by pretending that our turtle is facing north when it starts mining the vein.
